export const welcomeMail = (siteName: string, url: string): string => {
  ...
  return `
    ...
    <div style="font-family: Arial, Helvetica, sans-serif; line-height: 1.5rem;">
      ...
      <ul style="margin: 0; padding: 1rem 1rem 1rem 3rem; font-family: inherit; color: #727272;">
        <li>Creation of Notes and Sections</li>
        <li>Rich Text Editing</li>
        <li>Editing of Notes and Sections</li>
        <li>Tags and more</li>
      </ul>
...
export const exitMail = (siteName: string, url: string): string => {
